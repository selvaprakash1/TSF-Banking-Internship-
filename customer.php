...
?>
      ...
      <!-- table starts -->
        <div class="container my-5">
            <h3 class="text-dark">Customers Details & their Balance </h3>
            ...
            <table class="table table-hover">
                ...
                <?php 
                  if($num_of_entry>0){
                    ...
                    <td>".$row['Email']."</td>
                    <td>".$row['Amount']."</td>
                    <td><a href='send.php?name=".$row['Cust_Name']."'><button type='button' class='btn btn-success btn-sm'>Send</button></a></td>
                  </tr>";
